...
for n in range(2, 13, 2):
    ...
    tr2 = vec.lin_to_mat(lambda X : qu.p_tr(X, (n, n), 1), (N, n), compact=(True, True), iscomplex=True)
    ikr_tr1 = vec.lin_to_mat(lambda X : qu.i_kr(qu.p_tr(X, (n, n), 0), (n, n), 0), (N, N), compact=(True, False), iscomplex=True)
