...
# Tr_1[X] == Tr_L[X]
tr1 = sym.lin_to_mat(lambda x : sym.p_tr(x, 1, (2, 2, 2, 2, 2)), (N, m), compact=(False, True))
trL = sym.lin_to_mat(lambda x : sym.p_tr(x, 0, (2, 2, 2, 2, 2)), (N, m), compact=(False, True))
...
# Define objective function corresponding to tr[HX]
...
cones = [qics.cones.QuantCondEntr((2, 2, 2, 2, 2), 0)]
