def test_ptr_ikr():
    ...
    sys_tests = [
        0, 1, 2, 3, 
        (0, 1), (2, 0), (0, 3), (2, 1), (1, 3), (3, 2),
        (0, 1, 2), (3, 0, 1), (0, 3, 2), (3, 2, 1),
        (0, 1, 2, 3)
    ]
...
def test_ptr_ikr_multi():
    ...
    for sys in sys_tests:
        ...
        assert np.allclose(
            np.trace(p_tr_multi(np.ones_like(Ys), Xs, dims, sys) @ Ys, axis1=1, axis2=2), 
            np.trace(Xs @ i_kr_multi(np.ones_like(Xs), Ys, dims, sys), axis1=1, axis2=2)
