...
eps = 1e-8
f0 = K.get_val()
g0 = [np.zeros((1, 1)), np.zeros((n, n), dtype=dtype), np.zeros((n, n), dtype=dtype)]
K.get_grad(g0)
...
K.set_point(x1, x1)
K.get_feas()
g1 = [np.zeros((1, 1)), np.zeros((n, n), dtype=dtype), np.zeros((n, n), dtype=dtype)]
K.get_grad(g1)
...
work = [np.zeros((1, 1)), np.zeros((n, n), dtype=dtype), np.zeros((n, n), dtype=dtype)]
